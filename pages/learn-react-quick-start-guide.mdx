...
কোম্পোনেন্ট রিইউজ করা সহজ — যেমন ওয়েবসাইটের `<Header />`, `<Footer />`  কম্পোনেন্ট একাধিক ফাইলে ব্যবহার করুন।

---

### React ক্লাস কম্পোনেন্ট (এখনকার সময় খুব কম ব্যবহার হয়) 
...
১। **CreditorList.jsx ফাইল ক্রিয়েট করুন। নিচের কোডটি পেস্ট করুন।** 
...
```
২। **Creditor.jsx ফাইল ক্রিয়েট করুন। নিচের কোডটি পেস্ট করুন।** 
