...
- If your goal is to become a full-stack developer, or you have device or internet problems, **please do not apply**.
- We are specificaslly looking for someone focused on **front-end development**.
- If you do not follow these three instructions, **you will not receive a reply**.
